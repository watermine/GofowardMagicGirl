...
public class ObjectInstantiate : MonoBehaviour
{
    ...
    public void CreatePlant()
    {
        ...
        GameObject plant1 = Instantiate(plantPrefab, new Vector2(3 + num,-5f), Quaternion.identity);
        GameObject plant2 = Instantiate(plantPrefab, new Vector2(-2 + num,-5f), Quaternion.identity);
        GameObject plant3 = Instantiate(plantPrefab, new Vector2(-7 + num,-5f), Quaternion.identity);
